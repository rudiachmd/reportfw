<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?= base_url() ?>Karyawan_software/" class="logo">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li <?php if (isset($daftar_tiket)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_software/"><i class="fa fa-check-circle"></i> Tiket Respon</a></li>
              <li <?php if (isset($daftar_tiket_xresp)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_software/xresp/"><i class="fa fa-envelope-o"></i> Tiket Belum Respon</a></li>
              <li <?php if (isset($daftar_tiket_close)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_software/close/"><i class="fa fa-close"></i> Tiket Close</a></li>
            </ul>
          </li>
        </ul>
        </li>
    ...
    <div class="content-wrapper">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $row->date_time ?></td>
                          <td>
                            <a href="<?= base_url() ?>Karyawan_software/detail_tiket/<?= $row->id_ticket ?>"><button class="btn btn-app1" data-toggle="modal" data-target="#detailtiket"><i class="fa fa-edit"></i></button></a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="<?= base_url() ?>Karyawan_software/close_tiket/<?= $row->id_ticket ?>"><button type="button" class="btn btn-outline">Ya</button></a>
                              </div>
                            </div>
                            <!-- /.modal-content -->
                          </div>
      ...
      <?php } elseif (isset($daftar_tiket_close)) { ?>
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="modal modal-danger fade" id="deletetiket">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Ya</button>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                ...
                <form class="form-horizontal" action="<?= base_url() ?>Karyawan_software/send_chat/" method="post">
                  <?php
