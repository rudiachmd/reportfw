<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?= base_url() ?>Karyawan_hardware/" class="logo">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li <?php if (isset($daftar_tiket)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_hardware/"><i class="fa fa-check-circle"></i> Tiket Respon</a></li>
              <li <?php if (isset($daftar_tiket_xresp)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_hardware/xresp/"><i class="fa fa-envelope-o"></i> Tiket Belum Respon</a></li>
              <li <?php if (isset($daftar_tiket_close)) echo 'class="active"'; ?>><a href="<?= base_url() ?>Karyawan_hardware/close/"><i class="fa fa-close"></i> Tiket Close</a></li>
            </ul>
          </li>
        </ul>
        </li>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $row->date_time ?></td>
                          <td>
                            <a href="<?= base_url() ?>Karyawan_hardware/detail_tiket/<?= $row->id_ticket ?>"><button class="btn btn-app1"><i class="fa fa-edit"></i></button></a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="<?= base_url() ?>Karyawan_hardware/close_tiket/<?= $row->id_ticket ?>"><button type="button" class="btn btn-outline">Ya</button></a>
                              </div>
                            </div>
                            <!-- /.modal-content -->
                          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                ...
                <form class="form-horizontal" action="<?= base_url() ?>Karyawan_hardware/send_chat/" method="post">
                  <?php
