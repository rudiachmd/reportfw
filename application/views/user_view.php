          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="pages/examples/profile_klien.html" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li <?php if(isset($daftarkan_tiket)) echo 'class="active"';?>><a><i class="fa fa-circle-o"></i> Daftarkan Tiket Anda</a></li<>
            <li <?php if(isset($daftar_tiket)) echo 'class="active"';?>><a><i class="fa fa-circle-o"></i>Tiket Anda</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
...
if(isset($daftar_tiket)){
    ...
    ?>
          ...
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="post" action="<?= base_url()?>User/form_tambah_tiket">
                <!-- text input -->
                ...
                <div class="form-group">
                    ...
                    <span class="text-danger"><?= form_error("pengguna")?></span>
                </div>
                <div class="form-group">
                    <label>Pilih Kategori:</label>
                    <select class="form-control" nama="kategori">
                        <?php
                        foreach ($daftar_kategori->result()as $row){
                            ?>
                            <option value="<?= $row->value?>"><?= $row->categories_name?> - <?= $row->problem_details?></option>
                            <?php
                        }
                        ?>
                    </select>
                ...
                <!-- textarea -->
                <div class="form-group">
                    <label>Masukkan Pertanyaan / Kendala</label>
                ...
                <div class="col-xs-4">
                  <button name="insert" value="Insert" type="submit" class="btn_submit-tiket">Kirim Tiket</button>
                </div>
              </form>
            </div>
            <!-- /.box-body -->
