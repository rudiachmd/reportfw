...
class Ion_auth
{
	...
	public function register_new($identity, $password, $email, $additional_data = [], $group_ids = [])
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_new($identity, $password, $email, $additional_data, $group_ids);
	...
	public function register_asking($identity, $password, $email, $additional_data = [], $group_ids = [])
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_asking($identity, $password, $email, $additional_data, $group_ids);
	...
	public function register_software($identity, $password, $email, $additional_data = [], $group_ids = [])
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_software($identity, $password, $email, $additional_data, $group_ids);
	...
	public function register_hardware($identity, $password, $email, $additional_data = [], $group_ids = [])
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_hardware($identity, $password, $email, $additional_data, $group_ids);
	...
	public function is_asking($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_asking');

		$admin_group = $this->config->item('asking', 'ion_auth');
